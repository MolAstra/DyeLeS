...
if __name__ == "__main__":
    ...
    # 载入数据
    df_raw_path = data_dir / "chembl" / "chembl_35_chemreps.txt"
    ...
    df.to_csv(processed_dir / "chembl.csv", index=False)
    logger.success(
        f"Saved {len(df)} processed molecules to {processed_dir / 'chembl.csv'}"
    )
